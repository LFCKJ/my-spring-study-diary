--데이터베이스가 없으면 생성
CREATE DATABSE IF NOT EXISTS diary_db CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS study_logs(
    ...
    understanding VARCHAR(20) NOT NULL '이해도(HIGH, MEDIUM, LOW)',
    study_time INT NOT NULL COMMENT '학습 시간(분)',
    study_date DATE NOT NULL COMMENT '학습 날짜',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP COMMENT '생성 일지',
